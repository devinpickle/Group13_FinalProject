...
class Enemy(arcade.Sprite, ABC):
    ...
    def enemy_movement_auto(self):
        """Controls enemy movement before any attack is triggered. Can be overrided to have none, and only target player the entire time.
...
# #code to test classes are working properly
